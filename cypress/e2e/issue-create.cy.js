...
describe('Issue create', () => {
  ...
  it('Should validate title is required field if missing', () => {
    ...
    cy.get('[data-testid="modal:issue-create"]').within(() => {
      ...
      cy.get('[data-testid="form-field:title"]').should('be.visible').should('contain', 'This field is required');
    });
  });

  it('Should create an new issue like described in Assignment #2 and validate it successfully', () => {
    cy.get('[data-testid="modal:issue-create"]',{ timeout: 40000 }).within(() => {
  ...
  it('Should create an new issue with random title and description and validate it successfully', () => {
